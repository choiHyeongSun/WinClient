...
{
    internal class ExitRoomMemberController : SingleTon<ExitRoomMemberController>, IRecvMessage, ISingleTon_Init, ISingleTon_Remove
    {
        ...
        {
            ControllerManager.RegisterRecvMessage(EMESSAGE_TYPE.EXIT_MEMBER, this);
        }

        public void Remove()
        {
            ControllerManager.UnregisterRecvMessage(EMESSAGE_TYPE.EXIT_MEMBER, this);
        }
    }
}
